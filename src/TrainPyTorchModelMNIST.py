...
def TrainPyTorchModelMNIST(use_cached):
    ...
    args = parser.parse_args('')  # parser.parse_args requires default filepath string
                                  # in jupyter notebook
    ...
    if use_cached and os.path.isfile("cache/model_PyTorch_MNIST.pt"):
        ...
        print("Loading previously trained PyTorch MNIST model.")
        is_trained = True
